...
@Component({
  ...
  templateUrl: 'ParentMeeting.html'
})
export class ParentMeeting {
      ...
      constructor(public navCtrl: NavController, public navParams: NavParams,
                  public dailydiary: ClassProvider, public toastController: ToastController,public loadingController:LoadingController) {}
    ...
    Submit() {
      this.navCtrl.push(ParentMeeting_selected,{
